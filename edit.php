...
if(!empty($_POST)){
	...
	$book_sql = 'UPDATE `book_recommend` SET  `bookname`, `member_id`, `reason`, `book_pic`, `created` = NOW() ';
											...
											<div class="login">
													...
													<!-- パスワード -->
														<div class="form-group" style="padding:0px 30px;">
															...
															<input type="file" name="book_pic" class="form-control" value="<?php echo $recommend['book_pic'] ?>>
													...
													<!-- おすすめする理由 -->
														<div class="form-group" style="padding:0px 30px;">
															...
															<textarea rows="6" style="resize:vertical; background: rgba(0, 0, 0, 0.1);" name= "reason" class="full-width form-control" placeholder="おすすめポイント！" value="<?php echo $recommend['reason'] ?>" ></textarea>
														</div>
														</div>
