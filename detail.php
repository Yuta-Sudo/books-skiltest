											...
											<div class="login">
													...
													<!-- 本の名前 -->
														<div class="form-group" style="padding:0px 30px;">
															<label class="control-label">本のタイトル</label>
												...
												<div class="col-md-6 copy animate-box"" >
													...
													<div class="form-group" style="padding:0px 30px; display:inline; height: auto;" >
														...
														<div class="col-md-12 col-sm-12" style="height:250px; overflow:hidden; overflow-y:scroll; border:0px solid #ccc; padding:0 20px;">
														<p class="check" style="color:#000; word-wrap: break-word; display: inline-block; width: 100%;"><?php echo $recommend['reason'] ?></p>
														</div>
													</div>
												</div>
											</form>
